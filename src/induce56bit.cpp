...
flbwt::BWT_result *flbwt::induce_bwt_56bit(uint32_t *SA_L, uint16_t *SA_M, int8_t *SA_U, flbwt::Container *container)
{
    ...
    {
        q = flbwt::get_56bit_value(SA_L, SA_M, SA_U, i) + bwp_base;
