...
flbwt::BWT_result *flbwt::induce_bwt_40bit(uint32_t *SA_L, int8_t *SA_U, flbwt::Container *container)
{
    ...
    {
        q = flbwt::get_40bit_value(SA_L, SA_U, i) + bwp_base;
    ...
    delete[] SA_L;
    delete[] SA_U;
    flbwt::decrease_memory_allocation((container->num_of_substrings + 2) * 5);
